...
###QUALITY RATINGS###
Assign a quality rating of either "Good", "Neutral" or "Bad" in each of the four categories. Internally, assign a value between 1-5 to each quality aspect. If the value is between 1-2, the quality is "Bad"; if it is 3, the quality is "Neutral"; if it is between 4-5, the quality is "Good".
"""

dimensions_v1 = """
###DIMENSIONS OF ARGUMENT QUALITY###

Assess each argument component based on the following dimensions. The overall rating (<Good>, <Neutral> or <Bad>) should be a reasoned synthesis of these aspects:
...
"cogency": "Good" | "Bad" | "Neutral",
"effectiveness": "Good" | "Bad"  | "Neutral", 
"reasonableness": "Good" | "Bad"  | "Neutral",
