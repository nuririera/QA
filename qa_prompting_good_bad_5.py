...
###QUALITY RATINGS###
Assign a quality rating of either "Relly Good", "Good", "Neutral", "Bad" or "Really Bad" in each of the four categories. Internally, assign a value between 1-5 to each quality aspect. If the value is 1, the quality is "Really Bad"; if it is 2, the quality is "Bad"; if it is 3, the quality is "Neutral"; if it is between 4, the quality is "Good" and if it is 5, the quality is "Relly Good".
"""

dimensions_v1 = """
###DIMENSIONS OF ARGUMENT QUALITY###

Assess each argument component based on the following dimensions. The overall rating (<Really Good>, <Good>, <Neutral>, <Bad> or <Really Bad> ) should be a reasoned synthesis of these aspects:
...
"cogency": "Really Good" | "Good" | "Bad" | "Neutral"  | "Really Bad",
"effectiveness": "Really Good" | "Good" | "Bad" | "Neutral"  | "Really Bad",
"reasonableness": "Really Good" | "Good" | "Bad" | "Neutral"  | "Really Bad",
"overall": "Really Good" | "Good" | "Bad" | "Neutral"  | "Really Bad"
}
