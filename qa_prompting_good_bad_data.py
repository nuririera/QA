...
###QUALITY RATINGS###
Assign a quality rating of either "Good" or "Bad" in each of the four categories. Internamente haz un proceso de asignar a ese aspecto de calidad un valor entre 1-5. Si el valor está entre 1-3 la calidad será bad si está entre 4-5 la calidad sera good 
"""
