...
###QUALITY RATINGS###
Assign a quality rating of either "Good" or "Bad" in each of the four categories. Internally, assign a value between 1-5 to each quality aspect. If the value is between 1-3, the quality is "Bad"; if it is between 4-5, the quality is "Good".
"""

dimensions_v1 = """
###DIMENSIONS OF ARGUMENT QUALITY###

Assess each argument component based on the following dimensions. The rating (<Good> or <Bad>) should be a reasoned synthesis of these aspects:
...
if __name__ == "__main__":
    ...
    print("2 - Summarized version with synthesis per dimension")
